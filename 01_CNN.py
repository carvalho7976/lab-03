...
#history = model.fit(x=aug.flow(x_train,y_train,batch_size=32, save_format='jpg', save_to_dir=save_path),epochs=n_epochs, verbose=0, validation_data=(x_test, y_test))
history = model.fit(x=aug.flow(x_train,y_train,batch_size=32),epochs=n_epochs, verbose=0, validation_data=(x_test, y_test))
